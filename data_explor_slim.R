...
ggplot(df_all_slim, aes(x = DATE)) +
  ...
  geom_vline(xintercept = as.numeric(as.Date("2020-01-30")), color = "red", linetype = "dashed") +
  # The World Health Organization declared the COVID-19 to be pandemic
  geom_vline(xintercept = as.numeric(as.Date("2020-03-11")), color = "blue", linetype = "dotdash") +
  # Russian aggression against Ukraine
  geom_vline(xintercept = as.numeric(as.Date("2022-02-24")), color = "black", linetype = "dashed") +
  # Bankruptcy of FTX
  geom_vline(xintercept = as.numeric(as.Date("2022-11-07")), color = "red", linetype = "dashed") +
  # Colapse of Silicon Valley Bank
  geom_vline(xintercept = as.numeric(as.Date("2023-03-10")), color = "blue", linetype = "dotted") +
